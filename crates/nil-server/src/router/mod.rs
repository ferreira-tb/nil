...
pub(crate) fn create() -> Router<App> {
  ...
  let router = Router::new()
    ...
    .route("/cheat-set-max-food", get(cheat::resources::set_max_food))
    .route("/cheat-set-max-infrastructure", post(cheat::infrastructure::set_max_infrastructure))
    .route("/cheat-set-max-iron", get(cheat::resources::set_max_iron))
    .route("/cheat-set-max-resources", get(cheat::resources::set_max_resources))
    .route("/cheat-set-max-silo-resources", get(cheat::resources::set_max_silo_resources))
    .route("/cheat-set-max-stone", get(cheat::resources::set_max_stone))
    .route("/cheat-set-max-warehouse-resources", get(cheat::resources::set_max_warehouse_resources))
    .route("/cheat-set-max-wood", get(cheat::resources::set_max_wood))
